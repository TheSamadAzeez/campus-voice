...
export default async function AdminFeedbackPage() {
  ...
  const { stats, ratingDistribution } = feedbackData.data!
  ...
  return (
    <div className="container mx-auto space-y-6 p-6">
      ...
      {/* Analytics Charts - Faculty performance removed for department admins */}
      <FeedbackAnalytics ratingDistribution={ratingDistribution} />
