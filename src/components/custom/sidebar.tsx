...
import { adminLinks, studentLinks, departmentAdminLinks } from '@/utils/links'
import Link from 'next/link'
import { usePathname } from 'next/navigation'

export function Sidebar({ admin, departmentAdmin }: { admin?: boolean; departmentAdmin?: boolean }) {
  const pathname = usePathname()

  // Determine which links to use based on role
